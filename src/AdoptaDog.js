  ...
  const handleCardClick = () => {
    ...
    return (
      ...
      <div className="container91">
        ...
        <div className="moref3">
      <h2 style={{ color: 'rgb(71, 196, 245)' }}>Breed</h2>
      <hr style={{ color: 'gray' }} />
      <input type="checkbox" id="breed1" className="customCheckbox"/>
      <label htmlFor="breed1"  className="customLabel">French Bulldog</label><br />
      <hr style={{ color: 'gray' }} />
      <input type="checkbox" id="breed2" className="customCheckbox"/>
      <label htmlFor="breed2"  className="customLabel">Labrador Retriever</label><br />
      <hr style={{ color: 'gray' }} />
      <input type="checkbox" id="breed3" className="customCheckbox"/>
      <label htmlFor="breed3" className="customLabel">Golden Retriever</label><br />
      <hr style={{ color: 'gray' }} />
      <input type="checkbox" id="breed4" className="customCheckbox" />
      <label htmlFor="breed4"  className="customLabel">German Shepherd</label><br />
      <hr style={{ color: 'gray' }} />
      <input type="checkbox" id="breed5" className="customCheckbox"/>
      <label htmlFor="breed5"  className="customLabel">Poodle</label><br />
      <hr style={{ color: 'gray' }} />
      <input type="checkbox" id="breed6" className="customCheckbox"/>
      <label htmlFor="breed6"  className="customLabel">Bulldog</label><br />
      <hr style={{ color: 'gray' }} />
      <input type="checkbox" id="breed7" className="customCheckbox"/>
      <label htmlFor="breed7"  className="customLabel">Beagle</label><br />
      <hr style={{ color: 'gray' }} />
      <input type="checkbox" id="breed8" className="customCheckbox"/>
      <label htmlFor="breed8"  className="customLabel">Rottweiler</label><br />
      <hr style={{ color: 'gray' }} />
      <input type="checkbox" id="breed9" className="customCheckbox"/>
      <label htmlFor="breed9"  className="customLabel">German Shorthaired Pointer</label><br />
      <hr style={{ color: 'gray' }} />
      <input type="checkbox" id="breed10" className="customCheckbox" />
      <label htmlFor="breed10"  className="customLabel">Pembroke Welsh Corgi</label><br />
      <hr style={{ color: 'gray' }} />
      <input type="checkbox" id="breed11" className="customCheckbox"/>
      <label htmlFor="breed11"  className="customLabel">Dachshund</label><br />
      <hr style={{ color: 'gray' }} />
      <input type="checkbox" id="breed12" className="customCheckbox"/>
      <label htmlFor="breed12"  className="customLabel">Yorkshire Terrier</label><br />
      <hr style={{ color: 'gray' }} />
      <input type="checkbox" id="breed13" className="customCheckbox"/>
      <label htmlFor="breed13"  className="customLabel">Australian Shepherd</label><br />
      <hr style={{ color: 'gray' }} />
      <input type="checkbox" id="breed14" className="customCheckbox"/>
      <label htmlFor="breed14"  className="customLabel">Boxer</label><br />
      <hr style={{ color: 'gray' }} />
      <input type="checkbox" id="breed15" className="customCheckbox"/>
      <label htmlFor="breed15"  className="customLabel">Siberian Husky</label><br />
      <hr style={{ color: 'gray' }} />
    </div>
